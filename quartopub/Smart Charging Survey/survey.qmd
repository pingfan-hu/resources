...
<center>
<a href="https://carsurvey3.formr.org/" class="btn btn-success" role="button" target="_blank"> Survey </a> <a href="https://gwu.quarto.pub/smc/" class="btn btn-primary" role="button" target="_blank"> SMC Attributes </a> <a href="https://gwu.quarto.pub/v2g/" class="btn btn-primary" role="button" target="_blank"> V2G Attributes </a>
</center>
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='default', fig.asp=1, fig.width=4, out.width="90%"}
library(ggplot2)
...
option_2 <- tibble(
    ...
    `Monthly Cash:` = scales::dollar(alt2$monthly_cash),
    `Override Allowance:` = paste(alt2$override, "per Month")
)
